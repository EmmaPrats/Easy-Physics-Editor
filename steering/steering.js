...
function eptfg_initHunterAndGatherer()
{
    ...
    eptfg_target = new Vector (getRandomBetween(-eptfg_scenescale/2, eptfg_scenescale/2), getRandomBetween(-worldHeight/2, worldHeight/2));//new Vector (getRandomBetween (-worldWidth/2, worldWidth/2), getRandomBetween(-worldHeight/2, worldHeight/2));
}
